...
const INITIAL_STATE = {
  courses: { active: null, list: null, error: null, loading: null },
...
export default function (state = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case DASHBOARD_COURSE_LIST_FETCH:
      return { ...state, courses: { active: state.courses.active, list: null, error: null, loading: true } };
    case DASHBOARD_COURSE_LIST_SUCCESS:
      return { ...state, courses: { active: state.courses.active, list: action.payload, error: null, loading: false } };
    case DASHBOARD_COURSE_LIST_FAILURE:
      return { ...state, courses: { active: state.courses.active, list: null, error: action.payload, loading: false } };
    case DASHBOARD_COURSE_LIST_RESET:
      return { ...state, courses: { active: state.courses.active, list: null, error: null, loading: false } };

    case DASHBOARD_COURSE_SELECT:
      return { ...state, courses: { active: state.courses.active, list: state.courses.list, error: null, loading: true } };
    case DASHBOARD_COURSE_SELECT_SUCCESS:
      return { ...state, courses: { active: action.payload, list: state.courses.list, error: null, loading: false } };
    case DASHBOARD_COURSE_SELECT_FAILURE:
      return { ...state, courses: { active: state.courses.active, list: state.courses.list, error: action.payload, loading: false } };
    case DASHBOARD_COURSE_SELECT_RESET:
      return { ...state, courses: { active: state.courses.active, list: state.courses.list, error: null, loading: false } };
