import { USER_FETCH_RESET, USER_UPDATE_FAILURE, USER_FETCH_FAILURE, USER_FETCH, USER_FETCH_SUCCESS, USER_UPDATE, USER_UPDATE_RESET, USER_UPDATE_SUCCESS,
...
export default function (state = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case USER_UPDATE_SUCCESS:
      return { ...state, active: { user: action.payload, error: null, loading: false }, updated: true, error: false };
